        ...
        <div className="container">
          <div className={'row '}>
            <div className="col">
              ...
              <p className="">
                We are an opensource based company. Follow us on{' '}
                <a href="https://git.qoto.org/goblin-ogm">QOTO GitLab</a>.
              </p>
            </div>
          </div>
              ...
              <div className="card" style={{ height: 400 }}>
                <ResponsiveContainer>
                  ...
                  >
                    ...
                    <Area
                      type="monotone"
                      dataKey="@goblin-ogm/goblin-buildchain"
                      stackId="1"
                      stroke="#ffc658"
                      fill="#ffc658"
                    />
